            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Melodify', style: TextStyle(color: Colors.white, fontSize: 36, fontWeight: FontWeight.bold)),
                    ...
                    child: Row(
                      children: [
                        const Padding(
                          ...
                          child: Icon(Icons.mail_outline, color: Color(0xFF888888), size: 20),
                        ),
                        Expanded(
                          child: TextField(
                            controller: _email,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        const Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16),
                          child: Icon(Icons.lock_outline, color: Color(0xFF888888), size: 20),
                        ),
                        Expanded(
                          child: TextField(
