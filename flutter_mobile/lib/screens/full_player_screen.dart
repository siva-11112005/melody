              ...
              child: DraggableScrollableSheet(
                ...
                builder: (_, scrollController) {
                  return ListView(
                    ...
                    children: [
                      const Center(child: Icon(Icons.playlist_add, color: Color(0xFF1DB954), size: 34)),
                      const SizedBox(height: 10),
                      const Text('Add to Playlist', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800)),
                      const SizedBox(height: 8),
                      Text('${track.title} — ${track.artist}', textAlign: TextAlign.center, style: const TextStyle(color: Colors.white70)),
                      const SizedBox(height: 18),
                      TextField(
                        controller: _playlistName,
                        style: const TextStyle(color: Colors.white),
                        decoration: const InputDecoration(hintText: 'New playlist name', prefixIcon: Icon(Icons.add_circle_outline)),
                      ),
                      ...
                      ElevatedButton(
                        ...
                        child: const Text('Create Playlist & Add'),
                      ),
                      const SizedBox(height: 18),
                      if (loadingPlaylists)
        ...
        return DraggableScrollableSheet(
          ...
          builder: (_, scrollController) {
            return ListView(
              ...
              padding: const EdgeInsets.all(18),
              children: [
                const Center(child: Icon(Icons.queue_music, color: Color(0xFF1DB954), size: 34)),
                const SizedBox(height: 10),
                const Text('Queue', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800)),
                  ...
                  child: ListView(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: track.artwork != null
                                ...
                                : Container(width: 300, height: 300, color: const Color(0xFF2A2A2A), child: const Icon(Icons.music_note, color: Colors.white70, size: 60)),
                          ),
                        ),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          _buildPlayerAction(
                            icon: downloading ? Icons.cloud_download : Icons.download_outlined,
                            label: downloading ? 'Saving...' : 'Download',
                            color: downloading ? const Color(0xFF1DB954) : const Color(0xFFb3b3b3),
                          ...
                          _buildPlayerAction(
                            ...
                            label: 'Share',
                            onTap: () => Share.share('Listen to "${TextUtils.cleanSongTitle(track.title)}" by ${TextUtils.cleanSongTitle(track.artist)}'),
                          ),
                          _buildPlayerAction(
                          ...
                          _buildPlayerAction(
                            ...
                            label: 'Radio',
                            onTap: () {}, // Not implemented yet but UI parity
                          ),
                        ],
                      ),
                      const SizedBox(height: 12),
