  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 20, right: 20, top: 60, bottom: 15),
            child: Row(
              children: [
                Container(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Expanded(
                child: Text('Add to Playlist', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis),
              ),
              GestureDetector(
                onTap: () => Navigator.pop(context),
